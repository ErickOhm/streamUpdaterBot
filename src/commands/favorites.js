...
module.exports = {
  name: "favorites",
  aliases: ["fav", "favorites", "favorite"],
  ...
  async execute(message, args, client, collection) {
    ...
    if (option.toLowerCase() === "add") {
      ...
      collection
        ...
        .then(async (res) => {
          ...
          collection.update(
            ...
            {
              $push: {
                Favorites: { username: username, ID: userID, wasOnline: false },
              },
            }
          );
          ...
          const confirmation = new Discord.MessageEmbed()
            ...
            .setDescription(
              "You will receive updates whenever this user goes online"
            )
      ...
      collection
        .update(
          { ServerID: message.guild.id },
          { $pull: { Favorites: { username: username } } }
        )
        .then(() => {
